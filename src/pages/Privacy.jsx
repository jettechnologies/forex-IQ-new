  ...
  <Box backgroundColor = '#0e1113'>
    ...
    <Box p={4}>
      <Text fontSize="lg" lineHeight="1.5em">
        ...
        <p><b fontBold = 'bold'>Data Security:</b> The Forex IQ takes data security seriously. We employ industry-standard security measures to protect your information against unauthorized access, disclosure, or alteration. Your financial data, including payment information, is encrypted and securely stored. We do not store sensitive payment information on our servers.</p>
        <p><b fontBold = 'bold'>Data Sharing:</b> The Forex IQ does not sell your personal information to third parties. However, we may share your data with service providers and partners who assist in the delivery of our services. We may disclose information in response to legal requests, law enforcement, and government inquiries, or as necessary to protect our rights, privacy, safety, or property.</p>
        <p><b fontBold = 'bold'>Cookies and Tracking Technologies:</b> The Forex IQ may use cookies and tracking technologies to collect information about your use of the software. These technologies help us improve user experience and provide customized content.</p>
        <p><b fontBold = 'bold'>Your Choices:</b> You can access, review, and update your personal information through your account settings in the software. You can also unsubscribe from non-essential communications. You can disable cookies in your browser, but this may affect the functionality of the software.</p>
        <p><b fontBold = 'bold'>Childrens Privacy:</b> The Forex IQ is not intended for use by individuals under the legal age for trading in the Indian markets. We do not knowingly collect information from minors.</p>
        <p><b fontBold = 'bold'>Changes to Privacy Policy:</b> The Forex IQ may update this Privacy Policy to reflect changes in our practices or legal requirements. Users will be notified of any significant changes via email or a notice on the software.</p>
      </Text>
    </Box>
  </Box>
);
