  ...
  <Box backgroundColor = '#191b20' >
    ...
    <Box p={4}>
      <Text fontSize="lg" lineHeight={1.5} color = '#f4f4f4'>
        ...
        <p mt = {4}><b fontBold = 'bold' mb = {4}>Non-Refundable Circumstances:</b></p>
        ...
        <p mt = {4}><b fontBold = 'bold' mb = {4}>Refund Process:</b></p>
