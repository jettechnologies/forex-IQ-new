...
// import banner from '../assets/aboutUs_2.jpg'; // Adjust the import path according to your project structure
...
//         banner={banner}
//       />
//       <Grid templateColumns={{ base: "1fr", xl: "1fr 1fr" }} gap={10} px={{ base: 10, md: 20 }} py={10}>
...
//                 <Box key={index} p={4} border="1px solid" borderColor="gray.600" borderRadius="md" bg="#0e1113" width={{ base: "100%", md: "calc(50% - 1rem)" }} mb={4}>
