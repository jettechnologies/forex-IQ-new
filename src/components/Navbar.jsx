...
//         zIndex={10}
//       >
//         <Flex h="100%" alignItems="center" py={4} justifyContent={{base:"space-between", lg:"flex-start"}}>
...
//           </Link>
//           <Flex display={{ base: "none", lg: "flex" }} alignItems="center" gap="15vw" justifyContent="flex-end" flex = {1} border = "2px solid red">
//           <Box display={{ base: "none", lg: "flex" }} gap="1.5rem" justifyContent="space-around" rounded="lg" width = {"50%"} px={2} border="1px solid #4f5150">
//             <Link
//               as={RouterLink}
//               to="/"
//               px="0.5rem"
