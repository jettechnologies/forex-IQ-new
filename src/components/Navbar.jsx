        ...
        {isMobileMenuOpen && (
          ...
          >
            {/* <Flex direction = "column" rowGap={4}>
              <Link href="/" px={2} py={2} mr={4} onClick={toggleMobileMenu} fontFamily="'Rajdhani', sans-serif" border={"2px solid red"}>Home</Link>
              <Link href="/about-us" px={2} py={2} mr={4} onClick={toggleMobileMenu} fontFamily="'Rajdhani', sans-serif" border={"2px solid red"}>About Us</Link>
              <Link href="/contact-us" px={2} py={2} onClick={toggleMobileMenu} fontFamily="'Rajdhani', sans-serif" border={"2px solid red"}>Contact Us</Link>
            </Flex> */}
            <Link href="/" px={2} py={2} mr={4} onClick={toggleMobileMenu} _focus={{ boxShadow: 'none' }} _active={{ boxShadow: 'none' }} fontFamily="'Rajdhani', sans-serif"><Text fontSize="md">Home</Text></Link>
            <Link href="/about-us" px={2} py={2} mr={4} onClick={toggleMobileMenu} _focus={{ boxShadow: 'none' }} _active={{ boxShadow: 'none' }} fontFamily="'Rajdhani', sans-serif"><Text fontSize="md">About Us</Text></Link>
            <Link href="/contact-us" px={2} py={2} onClick={toggleMobileMenu} _focus={{ boxShadow: 'none' }} _active={{ boxShadow: 'none' }} fontFamily="'Rajdhani', sans-serif"><Text fontSize="md">Contact Us</Text></Link>
            <Flex mt={10} columnGap="2rem" rowGap={4} flexDirection={{ base: "column", md: "row" }}>
              <Button
                variant="outline"
                border="1px solid"
