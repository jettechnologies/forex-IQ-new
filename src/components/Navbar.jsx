...
//             </Box>
//           </Link>
//           <Flex border="1px solid #4f5150" display={{ base: "none", lg: "flex" }} alignItems="center" gap="1.5rem" rounded = "lg" justifyContent="space-between" width = {"40vw"}>
//             <Link
//               as={RouterLink}
//               to="/"
//               px="0.5rem"
...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        <Flex h="100%" alignItems="center" justifyContent="space-between" py={4}>
          <Link as={RouterLink} to="/" style={{ display: 'flex', alignItems: 'center' }} _focus={{ outline: "none" }} _active={{ outline: "none" }} >
            <Box height={"4rem"} position="relative">
              <Image src={Logo} alt="Logo" h="100%" w="100%" objectFit="contain" loading="lazy" />
              <Heading 
                color="#29ce56"
        ...
        {isMobileMenuOpen && (
          ...
          >
            <Flex direction="column" rowGap={4}>
              <Link as={RouterLink} to="/" style={{ padding: '0.5rem 1rem' }} onClick={toggleMobileMenu} _hover={{ color: "#29ce56" }} _focus={{ outline: "none" }} _active={{ outline: "none" }} fontFamily="'Rajdhani', sans-serif">Home</Link>
              <Link as={RouterLink} to="/about-us" style={{ padding: '0.5rem 1rem' }} onClick={toggleMobileMenu} _hover={{ color: "#29ce56" }} _focus={{ outline: "none" }} _active={{ outline: "none" }} fontFamily="'Rajdhani', sans-serif">About Us</Link>
              <Link as={RouterLink} to="/contact-us" style={{ padding: '0.5rem 1rem' }} onClick={toggleMobileMenu} _hover={{ color: "#29ce56" }} _focus={{ outline: "none" }} _active={{ outline: "none" }} fontFamily="'Rajdhani', sans-serif">Contact Us</Link>
            </Flex>
            <Flex mt={10} columnGap="2rem" rowGap={4} flexDirection={{ base: "column", md: "row" }}>
              <Button
                variant="outline"
